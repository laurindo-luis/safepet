...
public class BrokerMqtt {
    ...
    public static void connect(Context context, String ip, String id) {
    ...
    public static void unsubscribe(MqttAndroidClient client, String topic) {
        try {
            IMqttToken iMqttToken = client.unsubscribe(topic);
            iMqttToken.setActionCallback(new IMqttActionListener() {
                @Override
                public void onSuccess(IMqttToken asyncActionToken) {
                    Log.d(TAG, "Sucess");
